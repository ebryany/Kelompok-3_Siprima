...
-- Test query untuk memastikan semua berjalan dengan baik
SELECT 'Testing database...' as status;
SELECT * FROM dashboard_stats;
SELECT complaint_number, title, category_name, reporter_name, status 
